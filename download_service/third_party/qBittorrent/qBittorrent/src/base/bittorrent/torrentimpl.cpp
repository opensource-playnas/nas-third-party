...
void TorrentImpl::forceRecheck()
{
    ...
    m_nativeStatus.progress = 0;
    m_hasFileIoError = false;
...
void TorrentImpl::handleMetadataReceivedAlert(const lt::metadata_received_alert *p)
{
    ...
    m_session->handleTorrentNeedSaveResumeData(this);
    m_session->handleMetadataReceivedAlert(p);
}
...
void TorrentImpl::SetFileIoError(const QString& msg) {
    m_hasFileIoError = true;
}

bool TorrentImpl::hasFileIoError() {
    return m_hasFileIoError;
}
