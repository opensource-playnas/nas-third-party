...
void SessionImpl::saveStatistics() const
{
    ...
    std::unique_ptr<QSettings> settings = Profile::instance()->applicationSettings(u"nasbt-data"_s);
...
{
    const std::unique_ptr<QSettings> settings = Profile::instance()->applicationSettings(u"nasbt-data"_s);
