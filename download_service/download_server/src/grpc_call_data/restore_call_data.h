...
#ifndef NAS_DOWNLOAD_SERVER_SRC_RESTORE_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_RESTORE_CALL_DATA_H
...
using download::v1::RestoreRequest;
using download::v1::RestoreReply;
using download::v1::DownloadService;

class RestoreCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         RestoreCallData> {
 public:
  RestoreCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  RestoreReply response_;

  grpc::ServerAsyncResponseWriter<RestoreReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_RESTORE_CALL_DATA_H