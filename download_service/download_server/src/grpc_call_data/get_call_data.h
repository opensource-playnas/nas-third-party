...
#ifndef NAS_DOWNLOAD_SERVER_SRC_GET_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_GET_CALL_DATA_H
...
using download::v1::GetRequest;
using download::v1::GetReply;
...
class GetCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         GetCallData> {
 public:
  GetCallData(DownloadServiceImpl* service,
 ...
 private:
  void ProcessComplete(const std::vector<TaskInfoPtr>& task_info_list);
...
#endif  // NAS_DOWNLOAD_SERVER_SRC_GET_CALL_DATA_H