...
#ifndef NAS_DOWNLOAD_SERVER_SRC_PAUSE_ALL_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_PAUSE_ALL_CALL_DATA_H
...
using download::v1::PauseAllRequest;
using download::v1::PauseAllReply;
using download::v1::DownloadService;

class PauseAllCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         PauseAllCallData> {
 public:
  PauseAllCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  PauseAllRequest request_;
  PauseAllReply response_;

  grpc::ServerAsyncResponseWriter<PauseAllReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_PAUSE_ALL_CALL_DATA_H