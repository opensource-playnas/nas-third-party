...
#ifndef NAS_DOWNLOAD_SERVER_SRC_UPLOAD_TORRENT_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_UPLOAD_TORRENT_CALL_DATA_H
...
using download::v1::UploadTorrentFileReply;
using download::v1::UploadTorrentFileRequest;
using grpc::ServerCompletionQueue;
using grpc::ServerContext;

class UploadTorrentFileCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                     UploadTorrentFileCallData> {
 public:
  UploadTorrentFileCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  UploadTorrentFileRequest request_;
  UploadTorrentFileReply response_;

  grpc::ServerAsyncResponseWriter<UploadTorrentFileReply> responder_;
