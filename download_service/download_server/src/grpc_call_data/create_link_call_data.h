...
#ifndef NAS_DOWNLOAD_SERVER_SRC_CREATE_LINK_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_CREATE_LINK_CALL_DATA_H
...
using download::v1::CreateLinkDownloadTaskRequest;
using download::v1::CreateLinkDownloadTaskResponse;
using download::v1::DownloadService;

class CreateLinkDownloadTaskCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         CreateLinkDownloadTaskCallData> {
 public:
  CreateLinkDownloadTaskCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  CreateLinkDownloadTaskRequest request_;
  CreateLinkDownloadTaskResponse response_;

  grpc::ServerAsyncResponseWriter<CreateLinkDownloadTaskResponse> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_CREATE_LINK_CALL_DATA_H