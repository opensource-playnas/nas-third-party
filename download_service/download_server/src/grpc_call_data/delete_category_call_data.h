...
#ifndef NAS_DOWNLOAD_SERVER_SRC_DELETE_CATEGORY_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_DELETE_CATEGORY_CALL_DATA_H
...
using download::v1::DeleteCategoryRequest;
using download::v1::DeleteCategoryReply;
using download::v1::DownloadService;

class DeleteCategoryCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         DeleteCategoryCallData> {
 public:
  DeleteCategoryCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  DeleteCategoryRequest request_;
  DeleteCategoryReply response_;

  grpc::ServerAsyncResponseWriter<DeleteCategoryReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_DELETE_CATEGORY_CALL_DATA_H