...
#ifndef NAS_DOWNLOAD_SERVER_SRC_CLEAN_CATEGORY_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_CLEAN_CATEGORY_CALL_DATA_H
...
using download::v1::CleanCategoryRequest;
using download::v1::CleanCategoryReply;
using download::v1::DownloadService;

class CleanCategoryCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         CleanCategoryCallData> {
 public:
  CleanCategoryCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  CleanCategoryRequest request_;
  CleanCategoryReply response_;

  grpc::ServerAsyncResponseWriter<CleanCategoryReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_CLEAN_CATEGORY_CALL_DATA_H