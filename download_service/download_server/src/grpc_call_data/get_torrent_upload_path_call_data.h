...
#ifndef NAS_DOWNLOAD_SERVER_SRC_GET_TORRENT_PATH_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_GET_TORRENT_PATH_CALL_DATA_H
...
using download::v1::GetTorrentUploadPathRequest;
using download::v1::GetTorrentUploadPathReply;
using grpc::ServerCompletionQueue;
using grpc::ServerContext;

class GetTorrentUploadPathCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                     GetTorrentUploadPathCallData> {
 public:
  GetTorrentUploadPathCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  GetTorrentUploadPathRequest request_;
  GetTorrentUploadPathReply response_;

  grpc::ServerAsyncResponseWriter<GetTorrentUploadPathReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_UPLOAD_TORRENT_CALL_DATA_H