...
#ifndef NAS_DOWNLOAD_SERVER_SRC_CREATE_TORRENT_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_CREATE_TORRENT_CALL_DATA_H
...
using download::v1::CreateTorrentDownloadTaskRequest;
using download::v1::CreateTorrentDownloadTaskReply;
using download::v1::DownloadService;

class CreateTorrentDownloadTaskCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         CreateTorrentDownloadTaskCallData> {
 public:
  CreateTorrentDownloadTaskCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  CreateTorrentDownloadTaskRequest request_;
  CreateTorrentDownloadTaskReply response_;

  grpc::ServerAsyncResponseWriter<CreateTorrentDownloadTaskReply> responder_;
