...
#ifndef NAS_DOWNLOAD_SERVER_SRC_RESUME_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_RESUME_CALL_DATA_H
...
using download::v1::ResumeRequest;
using download::v1::ResumeReply;
using download::v1::DownloadService;

class ResumeCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         ResumeCallData> {
 public:
  ResumeCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  ResumeRequest request_;
  ResumeReply response_;

  grpc::ServerAsyncResponseWriter<ResumeReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_RESUME_CALL_DATA_H