...
#ifndef NAS_DOWNLOAD_SERVER_SRC_RETRY_ALL_CALL_DATA_H
#define NAS_DOWNLOAD_SERVER_SRC_RETRY_ALL_CALL_DATA_H
...
using download::v1::RetryAllRequest;
using download::v1::RetryAllReply;
using download::v1::DownloadService;

class RetryAllCallData
    : public nas::GrpcServerCallBase<nas::DownloadServiceImpl,
                                         RetryAllCallData> {
 public:
  RetryAllCallData(DownloadServiceImpl* service,
 ...
 private:
  ...
  RetryAllRequest request_;
  RetryAllReply response_;

  grpc::ServerAsyncResponseWriter<RetryAllReply> responder_;
  nas::CallResult call_request_;
};

};  // namespace nas

#endif  // NAS_DOWNLOAD_SERVER_SRC_RETRY_ALL_CALL_DATA_H