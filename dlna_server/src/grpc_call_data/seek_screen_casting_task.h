...
#ifndef NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_SEEK_SCREEN_CASTING_TASK_H_
#define NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_SEEK_SCREEN_CASTING_TASK_H_
...
class SeekScreenCastingTaskCallDate
    : public nas::GrpcServerCallDataBase<DlnaServiceAsyncImpl,
                                         SeekScreenCastingTaskCallDate> {
 public:
  SeekScreenCastingTaskCallDate(DlnaServiceAsyncImpl* service,
                                grpc::ServerCompletionQueue* cq,
                                nas::NasThread* cq_dispatch,
                                nas::NasThread* task_main)
      : nas::GrpcServerCallDataBase<DlnaServiceAsyncImpl,
                                    SeekScreenCastingTaskCallDate>(service,
                                                                   cq,
                                                                   cq_dispatch,
                                                                   task_main),
        responder_(&ctx_),
 ...
 protected:
  void Request(DlnaServiceAsyncImpl* service,
    ...
    if (service && cq) {
      service->RequestSeekScreenCastingTask(&ctx_, &request_, &responder_, cq,
                                            cq, this);
    }
  }
  ...
  void Finish() override {
    ...
    LOG(WARNING) << "on SeekScreenCastingTaskCallDate, errcode: "
 ...
 private:
  ...
  ::dlna::v1::SeekScreenCastingTaskRequest request_;
  ::dlna::v1::SeekScreenCastingTaskResponse response_;
  grpc::ServerAsyncResponseWriter<dlna::v1::SeekScreenCastingTaskResponse>
      responder_;
...
#endif  // NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_SEEK_SCREEN_CASTING_TASK_H_
