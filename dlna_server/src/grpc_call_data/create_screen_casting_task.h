...
#ifndef NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_CREATE_SCREEN_CASTING_TASK_H_
#define NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_CREATE_SCREEN_CASTING_TASK_H_
...
class CreateScreenCastingTaskCallDate
    : public nas::GrpcServerCallDataBase<DlnaServiceAsyncImpl,
                                         CreateScreenCastingTaskCallDate> {
 public:
  CreateScreenCastingTaskCallDate(DlnaServiceAsyncImpl* service,
 ...
 protected:
  void Request(DlnaServiceAsyncImpl* service,
    ...
    if (service && cq) {
      service->RequestCreateScreenCastingTask(&ctx_, &request_, &responder_, cq,
                                              cq, this);
    }
  }
  ...
  void Finish() override {
    ...
    LOG(WARNING) << "on CreateScreenCastingTaskCallDate, errcode: "
                 << call_result_.errcode;
    nas::WrapperSetResult(&ctx_).SetResult(call_result_);
    responder_.Finish(response_, grpc::Status::OK, this);
  }
  void ProcessComplete(const std::string& task_id, DlnaServiceErrorNo err_code);

 private:
  DlnaServiceAsyncImpl* async_service_ = nullptr;
  grpc::ServerContext ctx_;
  ::dlna::v1::CreateScreenCastingTaskRequest request_;
  ::dlna::v1::CreateScreenCastingTaskResponse response_;
  grpc::ServerAsyncResponseWriter<dlna::v1::CreateScreenCastingTaskResponse>
      responder_;
...
#endif  // NAS_DLNA_SERVER_SRC_GRPC_CALL_DATA_CREATE_SCREEN_CASTING_TASK_H_
